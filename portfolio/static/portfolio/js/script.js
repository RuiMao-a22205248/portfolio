...
var changeVideoBtn = document.getElementById("change-video-btn");
 ...
 var nightModeImage = "{% static 'portfolio/images/bg_b.mp4' %}";
 var dayModeImage = "{% static 'portfolio/images/bg2.mp4' %}";

    nightModeButton.addEventListener('click', function() {
      if (body.classList.contains('night-mode')) {
        body.classList.remove('night-mode');
        nightModeButton.innerHTML = '<i class="fa-solid fa-lightbulb"></i>';
        video.src = dayModeImage;
        body.style.color = '#ffffffda';
      } else {
        body.classList.add('night-mode');
        nightModeButton.innerHTML = '<i class="fa-regular fa-lightbulb"></i>';
        video.src = nightModeImage;
